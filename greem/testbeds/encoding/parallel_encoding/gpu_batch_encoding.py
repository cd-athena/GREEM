...
from greem.monitoring.gpu_monitoring import GpuMonitoring
from greem.utility.ffmpeg import create_dash_ffmpeg_cmd
from greem.utility.configuration_classes import EncodingConfig, Rendition, EncodingVariant
from greem.utility.timing import TimingMetadata, measure_time_of_system_cmd, IdleTimeEnergyMeasurement
...
def prepare_data_directories(
    ...
    if encoding_variant == EncodingVariant.BATCH:
        data_directories = ['/'.join(data_dir.split('/')[:-1])
...
if __name__ == '__main__':
    ...
    execute_encoding_benchmark(configs, timing_metadata)
